    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-4 mb-4" style="alignt-items:center;justify-content:center;">
                <li class="list-group-item mb-2" style="background-color: #43d868;cursor:pointer;"> <a href="#" class="btn user-link mb-2" style="align-items: center;alignt-items:center;justify-content:center; margin-left: 160px;color:white!important; font-weight: 600;" >All Chats</a></li>
                <ul class="list-group">
                    @foreach ($users as $user)
                        <li class="list-group-item" style="background-color: #61dfea;cursor:pointer;">
                            <a href="#" class="btn user-link" style="align-items: center;alignt-items:center;justify-content:center; margin-left: 130px;color:white!important; font-weight: 600;;" data-id="{{ $user->id }}">{{ $user->name }}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
