    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="product-box" style="border: 1px solid #ddd; border-radius: 5px; overflow: hidden; transition: box-shadow 0.3s; padding: 15px; background: #fff;">
                    <a href="{{ url('product_details', $product->id) }}" style="text-decoration: none; color: inherit;">
                        <div class="img-box text-center" style="position: relative;">
                            <img src="products/{{ $product->image }}" alt="{{ $product->title }}" style="width: 100%; height: 200px;">

                            <span class="badge badge-danger" style="position: absolute; top: 10px; left: 10px; background: #db4566; color: #fff; padding: 5px 10px; font-size: 12px; border-radius: 3px;">
                        ...
                        <div class="detail-box mt-3" style="text-align: center;">
                            ...
                            <h6 style="font-size: 14px; color: #db4566;">
                                <span style="text-decoration: line-through; color: #999;">$450{{ $product->original_price }}</span>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a class="btn btn-sm btn-success"
                            style="background-color: #5ecdec; color: white;"
                ...
                <div class="product-box " style="border: 1px solid #ddd; border-radius: 5px; overflow: hidden; transition: box-shadow 0.3s; padding: 15px; background: #fff;">
                    <a href="{{ url('product_details', $product->id) }}" style="text-decoration: none; color: inherit;">
                        ...
                        <div class="detail-box mt-3" style="text-align: center;">
                            <h6 style="font-size: 16px; font-weight: bold;">{{ $product->title }}</h6>
                            <h6 style="font-size: 14px; color: #db4566;">
                                <span style="text-decoration: line-through; color: #999;">$775{{ $product->original_price }}</span>
                                <span>${{ $product->price }}</span>
                            </h6>
                        </div>
                    </a>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="product-box" style="border: 1px solid #ddd; border-radius: 5px; overflow: hidden; transition: box-shadow 0.3s; padding: 15px; background: #fff;">
                    <a href="{{ url('product_details', $product->id) }}" style="text-decoration: none; color: inherit;">
                        <div class="img-box text-center" style="position: relative;">
                            <img src="products/{{ $product->image }}" alt="{{ $product->title }}" style="width: 100%; height: 200px;"> @if($product->discount)
                            <span class="badge badge-danger" style="position: absolute; top: 10px; left: 10px; background: #db4566; color: #fff; padding: 5px 10px; font-size: 12px; border-radius: 3px;">
                        ...
                        <div class="detail-box mt-3" style="text-align: center;">
                            <h6 style="font-size: 16px; font-weight: bold;">{{ $product->title }}</h6>
                            <h6 style="font-size: 14px; color: #db4566;">
                                <span style="text-decoration: line-through; color: #999;">${{ $product->original_price }}</span>
                                <span>${{ $product->price }}</span>
                            </h6>
                        </div>
                    </a>
