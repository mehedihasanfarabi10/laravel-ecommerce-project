...
@section('content')
    ...
    <x-guest-layout>
        <form method="POST" action="{{ route('seller.register.submit') }}">
            ...
            <!-- Business Name -->
            <div>
                <x-input-label for="business" :value="__('Business Name')" />
                <x-text-input id="business" class="block mt-1 w-full" type="text" name="business" :value="old('business')"
                    required autofocus autocomplete="business" />
